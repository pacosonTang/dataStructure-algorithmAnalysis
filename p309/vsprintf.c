 ...
 *======================================================================*/
/*
 //buf 是缓冲区，fmt==字符串，valist=char * , args=参数列表，从右往左，共5个参数；
 //本函数旨在 从参数列表 args 中找出实际值，并装入缓冲区 buf，并返回buf ，字符串长度； 
 */
...
PUBLIC int vsprintf(char *buf, const char *fmt, va_list args)
{
	...
	char	inner_buf[STR_DEFAULT_LEN]; //STR_DEFAULT_LEN=1024,const.h
	char	cs;
	int	align_nr;
