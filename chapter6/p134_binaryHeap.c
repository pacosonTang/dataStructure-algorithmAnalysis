...
int main()
{
	ElementType data[] = {150, 80, 40, 30, 10, 70, 110}; // P141
	BinaryHeap bh;
	int size;
	int i;	
	
	printf("\n\t=== test for inserting the binary heap with {150, 80, 40, 30, 10, 70, 110} in turn ===\n");
	bh = initBinaryHeap(14);
	size = 7;	
	...
	printf("\n\t=== test for deleting the minimum in binary heap ===\n");
	deleteMin(bh);		
	printBinaryHeap(bh);
