...
extern void printChatArray(ElementType* array, int size);
extern int isOperator(ElementType c);
extern int checkPriority(int p1, int p2);
extern int infix2postfix(Stack s, ElementType *output);
